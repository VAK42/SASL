...
class _SpeedChallengeScreenState extends State<SpeedChallengeScreen> {
    ...
    if (mounted) {
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          title: Text('Time\'s Up!', style: TextStyle(color: textColor, fontWeight: FontWeight.bold)),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text('Final Score', style: TextStyle(color: isDark ? Colors.grey[400] : Colors.grey[600])),
              const SizedBox(height: 8),
              Text('$_score', style: TextStyle(fontSize: 48, fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor)),
                ...
                Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text('New Best Score!', style: TextStyle(color: Colors.amber, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
            ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Speed Challenge', style: TextStyle(color: textColor, fontWeight: FontWeight.bold)),
        backgroundColor: scaffoldColor,
        elevation: 0,
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Icon(Icons.timer_outlined, size: 80, color: highlightColor),
                            ),
                            const SizedBox(height: 32),
                            Text('Ready To Race?', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: textColor)),
                            const SizedBox(height: 16),
                            Text(
                              'You Have 60 Seconds To Sign As Many Letters As Possible!',
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text('Start Challenge', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                              ),
                            ),
                          ],
                        ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text('Time Left', style: TextStyle(fontSize: 12, color: subTextColor, fontWeight: FontWeight.bold, letterSpacing: 1.0)),
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          color: _timeLeft <= 10 ? Colors.redAccent : textColor,
                                        ),
                                      ),
                                    ],
                                  ),
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Text('Score', style: TextStyle(fontSize: 12, color: subTextColor, fontWeight: FontWeight.bold)),
                                        Text('$_score', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: highlightColor)),
                                      ],
                                    ),
                                  ),
                                ],
                              ...
                              const Spacer(),
                              Text('Sign This Letter', style: TextStyle(fontSize: 16, color: subTextColor, fontWeight: FontWeight.w600)),
                              const SizedBox(height: 8),
                              Text(
                                _currentTarget,
                                style: TextStyle(
